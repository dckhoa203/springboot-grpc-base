...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.order.OrderRequest,
      com.example.order.OrderResponse> getPlaceOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlaceOrder",
      requestType = com.example.order.OrderRequest.class,
      responseType = com.example.order.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.order.OrderRequest,
      com.example.order.OrderResponse> getPlaceOrderMethod() {
    io.grpc.MethodDescriptor<com.example.order.OrderRequest, com.example.order.OrderResponse> getPlaceOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getPlaceOrderMethod = OrderServiceGrpc.getPlaceOrderMethod) == null) {
          OrderServiceGrpc.getPlaceOrderMethod = getPlaceOrderMethod =
              io.grpc.MethodDescriptor.<com.example.order.OrderRequest, com.example.order.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlaceOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.order.OrderResponse.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void placeOrder(com.example.order.OrderRequest request,
        io.grpc.stub.StreamObserver<com.example.order.OrderResponse> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                com.example.order.OrderResponse>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public com.example.order.OrderResponse placeOrder(com.example.order.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.order.OrderResponse> placeOrder(
        com.example.order.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLACE_ORDER:
          serviceImpl.placeOrder((com.example.order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.example.order.OrderResponse>) responseObserver);
          break;
        default:
